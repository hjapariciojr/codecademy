...
# 
# Choose a hypothesis test, import it from `scipy` and perform it.  Be sure to note the p-value.
...
# 
# Just like before, we need to know if this difference is statistically significant.  Choose a hypothesis test, import it from `scipy` and perform it.  Be sure to note the p-value.
# Is this result significant?

# In[54]:

contingency2 = [[200, 250], [250, 325]]
...
contingency3 = [[200, 2504], [250, 2500]]
chi2 = chi2_contingency(contingency3)
chi2
